<?php
    ...
    $sql = "SELECT commande.idCommande,users.nom,users.prenom,commande.dateCommande FROM commande,users WHERE commande.etat_commande='termine' AND commande.idUser=users.idUser ORDER BY commande.dateCommande ASC";
