    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
     <div class="carousel-inner">
       <div class="carousel-item active">
         <img style="height:500px; margin-top: 55px;" class="d-block w-100" src="../images/ps5.png" alt="First slide">
        </div>
       <div class="carousel-item">
         <img style="height:500px; margin-top: 55px;" class="d-block w-100" src="../images/Alienware.jpg" alt="Second slide">
       </div>
       <div class="carousel-item">
         <img style="height:500px; margin-top: 55px;" class="d-block w-100" src="../images/slide5.jpg" alt="Third slide">
       </div> 
     </div>
